...
class TestLangGraphServiceRealFiles:
    ...
    async def test_initialize_env_var_with_real_file(self, monkeypatch):
        """Test initialization with AGENT_CONFIG pointing to real file"""
    ...
    async def test_initialize_fallback_to_langgraph_json(self, monkeypatch):
        """Test fallback to langgraph.json when agent.json not found"""
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            # Change to temp directory and clear AGENT_CONFIG
            ...
            try:
                ...
                # Change back to original directory before TemporaryDirectory cleanup
