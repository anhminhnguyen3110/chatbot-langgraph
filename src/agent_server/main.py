"""FastAPI application for Agent (Agent Protocol Server)"""
...
current_dir = Path(__file__).parent.parent.parent  # Go up to agent root
...
app = FastAPI(
    title="Agent",
    description="Agent: Production-ready Agent Protocol server built on LangGraph",
    version="0.1.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
...
async def root() -> dict[str, str]:
    """Root endpoint"""
    return {"message": "Agent", "version": "0.1.0", "status": "running"}
